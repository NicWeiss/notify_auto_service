      ...
      <tr>
        <td bgcolor="#de6c20" style="background-color:#de6c20;padding:12px;border-bottom:1px solid #ececec">
          <table role="presentation" border="0" cellspacing="0"
            cellpadding="0" width="100%" style="width:100%!important;min-width:100%!important">
            <tbody>
              <tr>
                  ...
                  <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="100%">
                    <tbody>
                      ...
                      <tr>
                        <td style="padding-bottom:20px">
                          <p style="margin:0;color:#4c4c4c;font-weight:400;font-size:16px;line-height:1.25">
                            Введите представленный ниже 4-значный код
                        </p>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="padding-bottom:20px">
                          <p style="margin:0;color:#4c4c4c;font-weight:400;font-size:16px;line-height:1.25">
                          Не сообщайте данный код третьим лицам</p>
                          <p style="margin:0;color:#4c4c4c;font-weight:400;font-size:16px;line-height:1.25">
                          Если вы не запрашивали код, то просто проигнорируйте письмо</p>
                        </td>
                      </tr>
                    </tbody>
                  </table>
...
def get_template_for_reg_code(reg_code):
    return Template(html).substitute(reg_code=reg_code)
